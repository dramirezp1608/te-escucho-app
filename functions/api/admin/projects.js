...
export async function onRequestGet(context) {
    try {
        ...
        // GET all projects
        const result = await dataverseRequest(context.env, 'coem_proyectoinnovacions');
...
export async function onRequestPost(context) {
    try {
        ...
        // POST new project
        const result = await dataverseRequest(context.env, 'coem_proyectoinnovacions', 'POST', body);
